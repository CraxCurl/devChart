...
export function HeroUIStyles() {
  return (
    <style>{`
      ...
      .date-picker.w-64{width:16rem}.date-picker.min-w-72{min-width:18rem;width:fit-content}.date-picker[data-disabled=true]{opacity:.6}.date-picker.w-full{width:100%}
      .label{font-size:.875rem;line-height:1.25rem;font-weight:500;color:hsl(var(--foreground,240 10% 3.9%));display:none;}
      .required-mark{color:#ef4444}
      .description{font-size:.875rem;line-height:1.25rem;color:hsl(var(--muted-foreground,240 3.8% 46.1%))}
      .date-input-group{display:inline-flex;align-items:center;height:3rem;overflow:hidden;border-radius:.75rem;border:1px solid rgba(255,255,255,0.05);background:rgba(255,255,255,0.02);box-shadow:0 1px 2px rgba(0,0,0,.04);outline:none;transition:border-color .16s ease,box-shadow .16s ease,background-color .16s ease}
      .date-input-group:hover{border-color:rgba(255,255,255,0.1)}
      .date-input-group:focus-within{border-color:rgba(255,255,255,0.2);box-shadow:0 0 0 2px hsl(var(--ring,240 5% 64.9%) / .35)}
      ...
      .date-input-group__input{display:flex;flex:1;align-items:center;gap:1px;min-width:0;padding:.5rem .5rem .5rem 1rem;border:0;background:transparent;font-size:.875rem;line-height:1.25rem;unicode-bidi:isolate;color:white}
      ...
      .date-input-group__segment:focus,.date-input-group__segment[data-focused=true]{background:hsl(var(--primary,221 83% 53%) / .14);color:hsl(var(--foreground,0 0% 98%))}
      ...
      .date-picker__trigger:hover{background:rgba(255,255,255,0.1);color:hsl(var(--foreground,0 0% 98%))}
      ...
      .calendar-year-picker__trigger:hover,.calendar__nav-button:hover{background:rgba(255,255,255,0.1)}
      ...
      .calendar__cell:hover{background:rgba(255,255,255,0.1)}
      ...
      .calendar__cell[data-selected=true]{background:white;color:black;font-weight:700}
