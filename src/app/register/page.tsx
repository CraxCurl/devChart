      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 relative z-10 py-12">
        <div className="w-full max-w-sm animate-fade-in text-center space-y-6 mt-16">
          <div className="space-y-1">
            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white glow-text">Create Account</h1>
            <p className="text-[1.4rem] text-white/70 font-light">Join the Club Board today</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            {step === 1 ? (
              <form onSubmit={handleRegisterStep1} className="space-y-3 relative">
                <input
                  type="text"
                  required
                ...
                <p className="text-xs text-white/40 pt-2">
                  By signing up, you agree to the Club{" "}
                  <a href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Terms of Service</a> and{" "}
                  <a href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Privacy Policy</a>.
                </p>
              </form>
            ) : (
